...
<head>
    ...
    <style>
        ...
        .form-group input:focus, .form-group select:focus, .form-group textarea:focus { border-color: #009CFF; }
    ...
    <div class="content-area">
        ...
        <div class="form-card">
            <div class="form-card-header">
                <h5><i class="fa fa-pen me-2" style="color:#f59e0b"></i>Edit Shop Information</h5>
            </div>
            <div class="form-body">
                <form method="post" action="<%=request.getContextPath()%>/user/shoplist">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="shopImage" value="${shop.shopImage}" placeholder="https://...">
                    </div>
                    <div class="form-group">
                        <label>Status</label>
                        <select name="isActive">
                            <option value="true"  ${shop.active ? 'selected' : ''}>Active</option>
                            <option value="false" ${!shop.active ? 'selected' : ''}>Inactive</option>
                        </select>
                    </div>
                    <div class="form-actions">
                        <button type="submit" class="btn-save"><i class="fa fa-save me-1"></i>Save Changes</button>
